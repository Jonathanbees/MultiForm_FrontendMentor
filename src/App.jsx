...
function App() {
  ...
  return (
    <div className='grid grid-cols-1 lg:w-3/5 lg:grid-cols-[1fr_3fr] lg:bg-white sm:bg-Magnolia sm:w-full lg:h-4/6 lg:rounded-xl p-4 sm:p-0 sm:h-full lg:static sm:relative overflow-hidden rounded-none'>
